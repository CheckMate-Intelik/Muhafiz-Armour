      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 120 }} className="px-5 pt-4">
        {!loading && tab === 'Booking Requests' && ongoingCardBookings.length > 0
          ? ongoingCardBookings.map((ongoingCardBooking) => (
              <View key={ongoingCardBooking.id} className="mb-4 rounded-3xl bg-white p-4" style={cardShadow}>
                <View className="flex-row items-center justify-between">
              ...
              <View className="flex-row items-start justify-between">
                <View className="flex-1">
                  ...
                  <View className="mt-2 flex-row items-center gap-2">
                    ...
                    <View className="rounded-full bg-gray-100 px-3 py-1">
                      <Text className="text-[10px] font-extrabold text-gray-800">{formatRange(b.startTime, b.endTime)}</Text>
                    </View>
                  </View>
                </View>
