    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="px-5 pt-6">
        <View className="rounded-3xl bg-white p-4" style={cardShadow}>
          <Text className="text-sm font-extrabold text-gray-900">Create driver account</Text>
          <Text className="mt-1 text-xs font-semibold text-gray-500">Sign up with your details</Text>

          <View className="mt-4">
            <Field label="Phone number" value={phone} onChangeText={setPhone} placeholder="+63 911 111 1111" keyboardType="phone-pad" />
